...
import {
  RoleAssignParams,
  RoleAssignment as RolesAPIRoleAssignment,
...
export class Users extends APIResource {
  ...
  update(id: string, params: UserUpdateParams, options?: RequestOptions): APIPromise<User> {
    ...
    return this._client.patch(path`/zones/${zoneId}/users/${id}`, { body, ...options });
  }
   ...
   * Delete a user
   */
  delete(id: string, params: UserDeleteParams, options?: RequestOptions): APIPromise<void> {
    const { zoneId } = params;
    return this._client.delete(path`/zones/${zoneId}/users/${id}`, {
      ...options,
...
export interface UserUpdateParams {
  ...
  /**
   * Body param: Status of the user. Set to `disabled` to prevent the user from
   * authenticating and revoke their active sessions, or `active` to re-enable.
   */
  status?: 'active' | 'disabled';
}
...
export declare namespace Users {
  ...
  export {
    Roles as Roles,
    type RolesAPIRoleAssignment as RoleAssignment,
