...
export class Roles extends APIResource {
   ...
   * are always null.
   */
  list(userID: string, params: RoleListParams, options?: RequestOptions): APIPromise<RoleListResponse> {
    const { zoneId, ...query } = params;
    return this._client.get(path`/zones/${zoneId}/users/${userID}/roles`, { query, ...options });
  }
   ...
   */
  assign(userID: string, params: RoleAssignParams, options?: RequestOptions): APIPromise<RoleAssignment> {
    const { zoneId, ...body } = params;
    return this._client.post(path`/zones/${zoneId}/users/${userID}/roles`, { body, ...options });
  }
  ...
  revoke(roleID: string, params: RoleRevokeParams, options?: RequestOptions): APIPromise<void> {
    const { zoneId, userId, scope_id, scope_type } = params;
    return this._client.delete(path`/zones/${zoneId}/users/${userId}/roles/${roleID}`, {
...
export declare namespace Roles {
  export {
    ...
    type RoleAssignmentCreate as RoleAssignmentCreate,
