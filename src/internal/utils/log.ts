...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: KeycardAPI): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: KeycardAPI): Logger {
