...
describe('resource versions', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.zones.policySets.versions.retrieve('version_id', { zone_id: 'zone_id', policy_set_id: 'policy_set_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('archive: only required params', async () => {
    const responsePromise = client.zones.policySets.versions.archive('version_id', { zone_id: 'zone_id', policy_set_id: 'policy_set_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listPolicies: only required params', async () => {
    const responsePromise = client.zones.policySets.versions.listPolicies('version_id', { zone_id: 'zone_id', policy_set_id: 'policy_set_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
